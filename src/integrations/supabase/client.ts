...
function createSupabaseClient() {
  ...
  if (!SUPABASE_URL || !SUPABASE_PUBLISHABLE_KEY) {
    ...
    // During SSR with ssr:false routes, delay initialization until client-side
    if (typeof window === 'undefined') {
      console.warn('[Supabase] Deferring client creation until browser environment');
      // Return a dummy client that will be replaced on first access
      return null as any;
    }
